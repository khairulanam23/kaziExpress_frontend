...
export default function InventoryPage() {
  ...
  const handleDeleteConfirm = () => {
    ...
    deleteProduct.mutate(deletingProduct.id, {
      onSuccess: () => {
        toast.success("Item discontinued", { description: `${deletingProduct.name} is no longer active inventory.` });
        setDeletingProduct(null);
      },
      onError: (error) => toast.error("Couldn't discontinue item", { description: getApiErrorMessage(error) }),
    });
  };
